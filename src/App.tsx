        ...
        <FadeIn className="relative z-10 text-center w-full max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <button 
              ...
              className="relative overflow-hidden group border border-cream/30 px-10 py-4 font-label tracking-widest uppercase text-sm text-cream transition-colors duration-500 hover:text-espresso hover:border-cream"
            >
              <span className="relative z-10">Order Online</span>
              <div className="absolute inset-0 bg-cream transform scale-x-0 origin-left transition-transform duration-500 ease-out group-hover:scale-x-100" />
            </button>
          </div>
        </FadeIn>
      </section>
